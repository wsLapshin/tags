...
use Tjventurini\Tags\App\Http\Requests\TagRequest as StoreRequest;
use Tjventurini\Tags\App\Http\Requests\TagRequest as UpdateRequest;
...
class TagCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('\Tjventurini\Tags\App\Models\Tag');
        ...
        */
        ...
        $this->crud->removeColumns(['slug', 'image', 'content']); // remove an array of columns from the stack
