@if ($crud->hasAccess('github_tags'))
	...
	<!-- visit documentation -->
	<a href="https://github.com/tjventurini/tags" target="_blank" class="btn btn-info ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-github"></i>&nbsp;{{ trans('tags::backpack.go_to_documentation') }}</span></a>
@endif
